...
typedef struct {
    ...
    int root_block;                                 // id of the root-block of the tree
    int num_blocks;                                 // how many blocks the bplus file has
...
void BP_PrintDatanodes(int file_desc, BPLUS_INFO *header_info);
